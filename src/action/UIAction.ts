...
export class UIAction {
    setEditingId = (context: 'editingTopicCardIds' | 'editingPostIds') => {
    ...
    removeEditingId = (context: 'editingTopicCardIds' | 'editingPostIds') => {
        const fn = <U extends { id: string }>(s: S, u: U) => {
    ...
    clearEditingIds = (context: 'editingTopicCardIds' | 'editingPostIds') => {
    ...
    toggleEditingIds = (context: 'editingTopicCardIds' | 'editingPostIds') => {
        const fn = <U extends { id: string }>(s: S, u: U) => {
